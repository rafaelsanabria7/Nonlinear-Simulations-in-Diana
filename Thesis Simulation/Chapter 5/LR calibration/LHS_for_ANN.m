...
%LHS for punching shear model calibration 03-11-2020
%====================================================================================================%
%                                              LHS                                                   %
%                                                                                                    %
...
mx_fc=41.56;  % According to Liberati tests (2019)
vx_fc=0.0329;
sigx_fc=mx_fc*vx_fc;

%Modulus of Eslasticity, Ec MPa
mx_Ec=25190; %21500*((mx_fc/10)^(1/3));
vx_Ec=0.0357;
sigx_Ec=mx_Ec*vx_Ec;

%Tensile Strength, fct MPa
mx_fct= 0.3*((mx_fc-8)^(2/3));
vx_fct= 0.18;
sigx_fct=mx_fct*vx_fct;

%Fracture of Energy , Gf 
mx_Gf= 73*((mx_fc)^0.18)*0.7; %/sqrt(2);
vx_Gf=0.15;
sigx_Gf=mx_Gf*vx_Gf;

% Spring Support, K
mx_K= 6500; % Deduced from Load-deflection curves
vx_K=0.15;
sigx_K=mx_K*vx_Gf;
